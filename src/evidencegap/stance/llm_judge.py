...
def _validate_result_payload(
    ...
    for index, raw in enumerate(raw_results):
        ...
        seen.add(input_id)
        try:
            label = canonical_stance_label(str(raw.get("label", "")))
...
def run_llm_stance_judge(
    ...
    *,
    ...
    if offset < 0:
        raise EvidenceGapError("offset cannot be negative")
    ...
    selected_inputs = all_inputs[offset : None if limit is None else offset + limit]
